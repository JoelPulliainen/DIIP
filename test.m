% Use script to test estim_coins function
% If calculation of mean images is not needed Imean function call can be
% commented out
...
%calculate means
[mean_bias,mean_dark,flat] = Imean();
...
for i = x
    ...
    coins{i-71} = estim_coins(measurement,mean_bias,mean_dark,flat)
end

% Test for single measurement images
